...
void add(Node **head)
{
    ...
    memset(&newcont, 0, sizeof(Unite));

    printf("Введите новое имя: ");
    scanf("%s", newcont.fio.name);

    printf("Введите новую фамилию: ");
    scanf("%s", newcont.fio.surname);
    ...
    switch (opt) {
        case 1:
            ...
            scanf("%s", newcont.fio.fathersname);
            break;
        case 2:
            break;
    }
    ...
    switch (opt) {
        case 1:
            ...
            scanf("%s", newcont.social.whatsapp);
            break;
        case 2:
            break;
    }
